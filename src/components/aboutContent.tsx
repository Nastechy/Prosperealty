                            ...
                            >
                                <span className="text-[14px] md:text-[16px] flex flex-col gap-4">
                                    <span>
                                        ...
                                        (RC: 7938121) is dedicated to empowering families by providing access to secure and thriving communities—where you can own your dream home or build your business with confidence.
                                    </span>
                                    <span>
                                        We value excellence, integrity, and the ability to consistently deliver professional, innovative real estate solutions.
                                    </span>
                                    <span>
                                        Your satisfaction is our top priority at every step. Our clients return—and recommend us—because we support them from enquiry to ownership and beyond.
                                    </span>
                                </span>
                            </motion.p>
                        </motion.div>
